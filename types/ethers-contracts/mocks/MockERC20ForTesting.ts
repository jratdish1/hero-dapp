...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface MockERC20ForTestingInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'transferFrom', data: BytesLike): Result;
  ...
  export interface MockERC20ForTesting extends BaseContract {
    
    connect(runner?: ContractRunner | null): MockERC20ForTesting;
    waitForDeployment(): Promise<this>;

    interface: MockERC20ForTestingInterface;
