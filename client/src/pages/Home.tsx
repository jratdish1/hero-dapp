      ...
      <footer className="border-t border-border bg-card/30">
        ...
        <div className="bg-black/40 py-4 border-b border-border">
          <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="https://youtu.be/zpwKPiA1r20?si=GIKGq9AW0KsqaGcj" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-5 py-2.5 rounded-xl bg-red-600/90 hover:bg-red-600 transition-colors text-white font-semibold text-sm shadow-lg">
